            ...
            if(req.readyState == 4 && req.status == 200){
                ...
                Object.keys(ret).forEach(function(key, index) {
                    ...
                    if(this[key]['question'] !== ''){
                        table += "<tr height='45px' id=" + key + "><td>" + this[key] + "</td><td><input type='button' value='Autograde' id='" + key + "' onclick='gradeExam(" + key + ")'></td><td><input type='button' value='View Score' id='" + key + "' onclick='location.href=\"teacher_score.php?exam=" + key + "\"'></td></tr>";
                        }
                    }, ret);
                }
